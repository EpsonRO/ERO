# =========================
# EPSON RESETTER CMD Version
# =========================

$OutDir = "$env:TEMP\ERO-Tools"
if (-not (Test-Path $OutDir)) { New-Item -ItemType Directory -Path $OutDir | Out-Null }

# Define tools and direct download URLs
$tools = @(
...
Write-Host "Downloading $($tool.Model)..." -ForegroundColor Yellow
...
try {
    ...
    Write-Host "Download failed! Check the URL or your internet connection." -ForegroundColor Red
    exit
}
